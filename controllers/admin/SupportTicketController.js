...
exports.list = async(req, res) => {
    ...
    try {
        ...
        let options = {page: reqData?.pageNumber || 1, limit: 10, populate: 'userId', sort: isSortCreatedAt ? { lastRepliedAt: 'desc', ...reqData?.orderBy }: reqData?.orderBy , lean: true,}
        // } Page calculation
...
exports.details = async(req, res) => {
    ...
    try {
        ...
        // dd(quickReplies);
        const record = await SupportTicket.findById(id).populate('userId').populate('reply.adminId').exec();
